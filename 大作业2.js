...
* @Last Modified time: 2019-01-04 19:45:45
*/
//加减数量
...
ml.innerHTML="'150ml'";
mlo.style.backgroundImage="url('../Web开发二大作业/任务所需小图/img/duigou.png')";
...
mlt.onclick=function(){
	ml.innerHTML="'200ml'";
	mlt.style.backgroundImage="url('../Web开发二大作业/任务所需小图/img/duigou.png')";
...
z1.onclick=function(){
	if(z2.style.border='none'){
		...
		tu.src="../Web开发二大作业/任务所需小图/img/pp0.jpeg";
		Bimg.src="../Web开发二大作业/任务所需小图/img/pp0.jpeg";
	}
}
...
z3.onmouseover=function(){
	...
	tu.src="../Web开发二大作业/任务所需小图/img/pp1.jpeg";
	Bimg.src="../Web开发二大作业/任务所需小图/img/pp1.jpeg";
}
z4.onclick=function(){
